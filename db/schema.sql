...
-- Openstaand: uitsluitend betaalregels van EUR 0,00 -- die maand is uitgevraagd
-- en er is niets binnengekomen, dus dat is de schuld. Het bedrag is wat het had
-- moeten zijn: tso-dagen x dagprijs.
-- Bewust NIET meegeteld: lege cellen (geen betaalregel; die worden later alsnog
-- gevuld) en deelbetalingen (bedrag > 0 maar lager dan verschuldigd).
-- Buiten beschouwing: leergeld-leerlingen, maanden voor de instroom, uitgesloten
-- maanden en maanden met een regeling (gelijk aan het Deelnemers-TSO-rapport).
